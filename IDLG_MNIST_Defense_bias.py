...
from DP_noise.Laplace import add_laplace_noise_to_bias, add_laplace_noise_to_bias_gradients
...
def main():
    ...
    print( '\n\nStart to add differential privacy noise ~~' )
    if epsilon == -1:
        noisy_dy_dx = original_dy_dx
    else:
        noisy_dy_dx = add_laplace_noise_to_bias_gradients(net.named_parameters(), original_dy_dx, epsilon)
    ...
    img_name = 'Defense_iDLG_attack_bias_epsilon_' +str(epsilon) + '_' + str(random.randint(0, 1000000)) + '.png'
