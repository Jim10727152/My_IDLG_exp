...
from DP_noise.Laplace import add_laplace_noise_to_gradients, add_staircase_noise_to_gradients
...
def main():
    ...
    if epsilon == -1:
        ...
        if dp_noise_mechanism == 'laplace':
            noisy_dy_dx = add_laplace_noise_to_gradients(original_dy_dx, epsilon)
